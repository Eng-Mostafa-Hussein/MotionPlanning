...
PROJECT_ROOT="${HOME}/My-projects/Fall-2017/MotionPlanning"

DATA_ROOT="${PROJECT_ROOT}/experiments/data"
EXEC="${PROJECT_ROOT}/build/MotionPlanning"

SEARCH="${HOME}/My-projects/Fall-2017/MotionPlanning/search"
...
#echo "sendSlackNotification.bash \"#experiments\" \"experiment_bot\" \"Tianyi just started running experiments.\""
...
do
  ...
  do
	...
	do
	  ...
	  echo "if [ ! -s $outputFile ]; then $inputFile | $EXEC; fi &&" 
	done
      done
    done
  done
...
#echo "sendSlackNotification.bash \"#experiments\" \"experiment_bot\" \"Tiany's experiments just finished.\""
